...
namespace NzbDrone.Core.Test.MediaFiles
{
    ...
    public class DownloadedBooksCommandServiceFixture : FileSystemTest<DownloadedBooksCommandService>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>()
                .Setup(v => v.ProcessPath(It.IsAny<string>(), It.IsAny<ImportMode>(), It.IsAny<Author>(), It.IsAny<DownloadClientItem>(), It.IsAny<List<Book>>()))
                .Returns(new List<ImportResult>());
        ...
        public void should_process_folder_with_downloadclientitem_if_available()
        {
            ...
            Mocker.GetMock<IDownloadedBooksImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, _trackedDownload.RemoteBook.Author, _trackedDownload.DownloadItem, _trackedDownload.RemoteBook.Books), Times.Once());
        }
